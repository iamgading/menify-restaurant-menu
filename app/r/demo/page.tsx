  ...
  const demoCategories = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          price: 22000,
          image_url: 'https://images.unsplash.com/photo-1612927601601-6638404737ce?w=800&q=80',
          is_available: true,
          sort_order: 2,
          created_at: new Date().toISOString(),
          updated_at: new Date().toISOString(),
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          price: 15000,
          image_url: 'https://images.unsplash.com/photo-1623065422902-30a2d299bbe4?w=800&q=80',
          is_available: true,
          sort_order: 4,
          created_at: new Date().toISOString(),
          updated_at: new Date().toISOString(),
      ...
      items: [
        {
          ...
          price: 10000,
          image_url: 'https://images.unsplash.com/photo-1587132117816-5a4bcd0c1b4e?w=800&q=80',
          is_available: true,
          sort_order: 1,
          created_at: new Date().toISOString(),
          updated_at: new Date().toISOString(),
